...
const FeedCliente = () => {
  ...
  const handleVerMais = (id: string) => {
    router.push(`/DetalhesPasseio/${id}`)
  }
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.cardsContainer}>
            ...
            <div className={styles.cardSmall}>
              ...
              <button onClick={() => handleVerMais('reserva_mantiqueira')}>Ver mais</button>
            </div>
            {/* Card 2 */}
            <div className={styles.cardSmall}>
            <Image alt='praia dos carneiros' src={praia_carneiros} />
              ...
              <button onClick={() => handleVerMais('praia_carneiros')}>Ver mais</button>
            </div>
            {/* Card 3 */}
            <div className={styles.cardSmall}>
            <Image alt='cachoeira diamantina' src={cachoeira_diamantina} />
              ...
              <button onClick={() => handleVerMais('cachoeira_diamantina')}>Ver mais</button>
            </div>
            {/* Card 4 */}
            <div className={styles.cardSmall}>
              ...
              <button onClick={() => handleVerMais('porto_de_galinhas')}>Ver mais</button>
            </div>
            {/* Card 5 */}
            {/*<div className={styles.cardSmall}>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.recommendations}>
            <TravelCard 
              imageUrl={'/trilha_dos_cocais.png'}
              title={'Trilha dos cocais'}
              author={'Autor'} 
              rating={5} 
              oldPrice={150} 
              newPrice={99}
              id={'trilha_dos_cocais'} />

            <TravelCard 
              imageUrl={'/praia_pescadores.png'}

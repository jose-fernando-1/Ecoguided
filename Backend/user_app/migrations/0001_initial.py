    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estilo_ecotrip', models.ManyToManyField(blank=True, related_name='preferencia_estilo', to='user_app.preferencecategory')),
                ('prefere_viajar_com', models.ManyToManyField(blank=True, related_name='preferencia_companhia', to='user_app.preferencecategory')),
                ('prioridade_viagem', models.ManyToManyField(blank=True, related_name='prioridade_viagem', to='user_app.preferencecategory')),
